        ...
        <React.Fragment>
            <Hidden mdDown>
                <Paper
                    ...
                    square={true}
                >
                    <OScrollbar className={clsx("content", classes.content)}>
                        {props.children}
                    </OScrollbar>
...
OSideDrawer.propTypes = {};
OSideDrawer.defaultProps = {
    position: "left",
    opened: true
};

export default React.memo(OSideDrawer);
