...
import PageLayoutFlatSidebar from './PageLayoutFlatSidebar';
import PageLayoutFlatHeader from './PageLayoutFlatHeader';
...
const PageLayoutFlat = React.forwardRef(function (props, ref) {
        ...
        <div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
            ...
            <div className="flex flex-auto flex-col container z-10">
                ...
                {props.header && props.sidebarInner && (
                    <PageLayoutFlatHeader header={props.header} classes={classes}/>
                )}

                <div className={classes.wrapper}>

                    {(props.leftSidebarHeader || props.leftSidebarContent) && (
                        <PageLayoutFlatSidebar
                            position="left"
                    ...
                    <OScrollbar className={classes.contentWrapper} enable={props.innerScroll && !props.sidebarInner}>
...
PageLayoutFlat.defaultProps = {};

export default React.memo(PageLayoutFlat);
