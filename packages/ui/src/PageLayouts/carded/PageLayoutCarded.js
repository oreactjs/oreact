...
import PageLayoutCardedSidebar from './PageLayoutCardedSidebar';
import PageLayoutCardedHeader from './PageLayoutCardedHeader';
...
const PageLayoutCarded = React.forwardRef(function (props, ref) {
        ...
        <div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
            ...
            <div className="flex container w-full">
                ...
                >
                    ...
                    <PageLayoutCardedHeader header={props.header} classes={classes}/>
                    ...
                    <div className={clsx(classes.contentCard, props.innerScroll && 'inner-scroll')}>
                        ...
                        {props.content && (
                            <OScrollbar className={classes.content} enable={props.innerScroll} scrollToTopOnChildChange={props.innerScroll}>
                                {props.content}
                            </OScrollbar>
                        )}
                    </div>
...
PageLayoutCarded.defaultProps = {};

export default React.memo(PageLayoutCarded);
